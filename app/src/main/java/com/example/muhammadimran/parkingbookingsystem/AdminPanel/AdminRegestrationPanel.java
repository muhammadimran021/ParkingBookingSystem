...
public class AdminRegestrationPanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminLoginButton.setOnClickListener(view -> {
            if (AdminEmail.getText().toString().equals("admin@gmail.com") && AdminPassword.getText().toString().equals("admin123")) {
                mAuth.signInWithEmailAndPassword(AdminEmail.getText().toString(), AdminPassword.getText().toString()).addOnSuccessListener(authResult -> {
                    AdminEmail.setText("");
